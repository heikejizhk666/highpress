<!--吃水不忘挖井人，请勿删除版权，谢谢！-->
<!--删除版权可能会导致网站Bug，视为放弃一切技术支持！出问题自理！-->
<!--让更多人使用主题，作者才有动力继续更新下去-->
<!--本主题的制作耗时2天。你删除版权，你的良心难道不会痛吗？-->
<?php if (!defined('__TYPECHO_ROOT_DIR__')) exit; ?>

<link rel="stylesheet" href="<?php $this->options->themeUrl('style.css'); ?>">
	<div id="d" class="gd_block" style="height: 145px"></div>
		<div class="gd_copy gd_copy_middle">
			<b style="text-align: center">友情链接</b>
			<!--开启友链请去掉下面左右两边的注释-->
			
			<p><a href="<?php $this->options->friendurl1() ?>"><?php $this->options->friendname1() ?></a> · <a href="<?php $this->options->friendurl1() ?>"><?php $this->options->friendname2() ?></a> · <a href="<?php $this->options->friendurl1() ?>"><?php $this->options->friendname3() ?></a></p>
